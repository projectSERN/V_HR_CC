...
First, generate clip-wise ST maps and ground truth data for videos in all datasets, by running `python src/st_maps.py <GPU#> <VIPL-HR-V1/UBFC-rPPG/PURE/MPSC-rPPG>`. These are saved to the same folder where the dataset is stored (refer to [expected file directories](#expected-file-directories))
...
- for study with full VIPL-HR-V1, run `python src/main.py <VIPL-HR-V1/UBFC-rPPG/PURE/MPSC-rPPG> --GPU <#>`
- for study with VIPL-HR-V1_mini, run `python src/main.py VIPL-HR-V1 --CC_MINI --GPU <#>`
...
- for study with full VIPL-HR-V1, run `python src/main.py <xxx> --DATASET_2 <yyy> --CC_PROP <0.1/0.3/0.5/0.7> --GPU <#>` with all combinations of VIPL-HR-V1, UBFC-rPPG, PURE, and MPSC-rPPG
- for study with VIPL-HR-V1_mini, run `python src/main.py VIPL-HR-V1 --DATASET_2 <yyy> --CC_MINI --CC_PROP <0.1/0.3/0.5/0.7> --GPU <#>` and `python src/main.py <xxx> --DATASET_2 VIPL-HR-V1 --CC_MINI --CC_PROP <0.1/0.3/0.5/0.7> --GPU <#>` with all combinations of VIPL-HR-V1_mini, UBFC-rPPG, PURE, and MPSC-rPPG
...
- for study with full VIPL-HR-V1, run `python src/main.py VIPL-HR-V1 --CC_FULL --CC_FULL_PROPS <op_VIPL-HR-V1> <op_UBFC-rPPG> <op_PURE> <op_MPSC-rPPG> --GPU <#>`
- for study with VIPL-HR-V1_mini, run `python src/main.py VIPL-HR-V1 --CC_MINI --CC_FULL --CC_FULL_PROPS <op_VIPL-HR-V1_mini> <op_UBFC-rPPG> <op_PURE> <op_MPSC-rPPG> --GPU <#>`
